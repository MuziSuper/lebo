...
CREATE TABLE `order_item` (
                              ...
                              `total_amount` bigint DEFAULT '0' COMMENT '总金额（元）',
                              `gmt_created` datetime(6) DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间',
                              PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
                        ...
                        `session_key` varchar(255) COMMENT '微信会话密钥',
                        ...
                        `status` tinyint DEFAULT '0' COMMENT '用户状态 0:正常 1:不活跃 2:暂停 3:封禁 4:注销',
...
CREATE TABLE `order` (
                         ...
                         `open_id` varchar(255) NOT NULL DEFAULT '' COMMENT '用户 openid',
                         `total_amount` bigint DEFAULT '0' COMMENT '订单总金额（元）',
                         `pay_amount` bigint NOT NULL COMMENT '实际支付金额（元）',
