...
-- 电子产品
('prod_iphone15_001', 'Apple iPhone 15 Pro', 'Apple iPhone 15 Pro 256GB 原色钛金属 支持移动联通电信5G 双卡双待手机', '/icon/iphone15.jpg', '["苹果","手机","5G"]', '台', 1, 0, 8999, 50, 7500, 899, b'0', NOW(6), NOW(6), b'0'),
('prod_mate60_002', '华为 Mate 60 Pro', '华为 HUAWEI Mate 60 Pro 卫星通话 12GB+512GB 雅川青', '/icon/mate60.jpg', '["华为","手机","卫星通信"]', '台', 1, 0, 6999, 30, 5800, 699, b'0', NOW(6), NOW(6), b'0'),
('prod_mi14_003', '小米14 Ultra', '小米14 Ultra 徕卡光学 Summilux镜头 16GB+1TB 黑色', '/icon/mi14.jpg', '["小米","手机","徕卡"]', '台', 1, 0, 6499, 40, 5200, 649, b'0', NOW(6), NOW(6), b'0'),
('prod_macbook_004', 'Apple MacBook Air 13', 'Apple MacBook Air 13.6英寸 8核M2芯片 8GB 256GB 午夜色', '/icon/macbook.jpg', '["苹果","笔记本","办公"]', '台', 1, 0, 8999, 20, 7500, 899, b'0', NOW(6), NOW(6), b'0'),
('prod_ipad_005', 'iPad Pro 12.9英寸', 'iPad Pro 12.9英寸 M2芯片 512GB Wi-Fi版 银色', '/icon/ipad.jpg', '["苹果","平板","学习"]', '台', 1, 0, 9299, 25, 8000, 929, b'0', NOW(6), NOW(6), b'0'),
('prod_sony_006', 'Sony WH-1000XM5', 'Sony索尼 WH-1000XM5 头戴式无线降噪耳机 铂金银', '/icon/sony.jpg', '["索尼","耳机","降噪"]', '个', 1, 0, 1999, 100, 1500, 199, b'1', NOW(6), NOW(6), b'0'),
-- 服装鞋包
('prod_nike_007', 'Nike Air Force 1', 'Nike空军一号 低帮板鞋 纯白 男女同款', '/icon/nike.jpg', '["耐克","运动鞋","板鞋"]', '双', 2, 0, 799, 200, 500, 79, b'0', NOW(6), NOW(6), b'0'),
('prod_adidas_008', 'Adidas Ultra Boost', 'Adidas阿迪达斯 Ultra Boost 21 跑鞋 黑色', '/icon/adidas.jpg', '["阿迪达斯","跑鞋","boost"]', '双', 2, 0, 1099, 150, 700, 109, b'0', NOW(6), NOW(6), b'0'),
('prod_uniqlo_009', '优衣库 纯棉T恤', '优衣库 男装/女装 纯棉圆领T恤 多色可选', '/icon/uniqlo.jpg', '["优衣库","T恤","纯棉"]', '件', 2, 0, 79, 500, 40, 7, b'0', NOW(6), NOW(6), b'0'),
('prod_northface_010', 'The North Face 冲锋衣', '北面 1996 Retro Nuptse 羽绒服 冲锋衣 黑色', '/icon/northface.jpg', '["北面","冲锋衣","户外"]', '件', 2, 0, 2399, 60, 1600, 239, b'0', NOW(6), NOW(6), b'0'),
('prod_longchamp_011', 'Longchamp 饺子包', 'Longchamp珑骧 Le Pliage系列 饺子包 短柄中号 红色', '/icon/longchamp.jpg', '["珑骧","包包","通勤"]', '个', 2, 0, 899, 80, 600, 89, b'1', NOW(6), NOW(6), b'0'),
-- 食品饮料
('prod_snacks_012', '三只松鼠 坚果大礼包', '三只松鼠 每日坚果 混合坚果 750g/30包', '/icon/snacks.jpg', '["三只松鼠","坚果","零食"]', '盒', 3, 0, 129, 300, 80, 12, b'1', NOW(6), NOW(6), b'0'),
('prod_starbucks_013', '星巴克 咖啡豆', '星巴克 深度烘焙 咖啡豆 200g 哥伦比亚', '/icon/starbucks.jpg', '["星巴克","咖啡","咖啡豆"]', '袋', 3, 0, 89, 200, 50, 8, b'0', NOW(6), NOW(6), b'0'),
('prod_mengniu_014', '蒙牛 特仑苏', '蒙牛 特仑苏 纯牛奶 250ml*12盒 礼盒装', '/icon/mengniu.jpg', '["蒙牛","牛奶","特仑苏"]', '箱', 3, 0, 68, 400, 45, 6, b'0', NOW(6), NOW(6), b'0'),
-- 家居生活
('prod_muji_015', 'MUJI 香薰机', '无印良品 超声波香薰机 大号 定时功能 白色', '/icon/muji.jpg', '["无印良品","香薰","加湿"]', '个', 4, 0, 398, 80, 200, 39, b'1', NOW(6), NOW(6), b'0'),
('prod_chair_016', '网易严选 人体工学椅', '网易严选 人体工学椅 电脑椅 办公椅 黑色', '/icon/chair.jpg', '["网易严选","椅子","办公"]', '把', 4, 0, 899, 40, 550, 89, b'0', NOW(6), NOW(6), b'0'),
('prod_robot_017', '米家 扫地机器人', '米家 扫拖机器人 3C 智能扫地机 拖地机', '/icon/robot.jpg', '["小米","扫地机","智能"]', '台', 4, 0, 1299, 35, 900, 129, b'0', NOW(6), NOW(6), b'0'),
-- 美妆护肤
('prod_sk2_018', 'SK-II 神仙水', 'SK-II 护肤精华露 神仙水 230ml', '/icon/sk2.jpg', '["SK-II","神仙水","精华"]', '瓶', 5, 0, 1299, 60, 900, 129, b'0', NOW(6), NOW(6), b'0'),
('prod_loreal_019', 'L\'Oreal 防晒霜', '欧莱雅 小金管 防晒霜 30ml 隔离紫外线', '/icon/loreal.jpg', '["欧莱雅","防晒","隔离"]', '支', 5, 0, 119, 300, 70, 11, b'1', NOW(6), NOW(6), b'0'),
('prod_estee_020', 'Estee Lauder 小棕瓶', '雅诗兰黛 特润修护肌活精华露 小棕瓶 50ml', '/icon/estee.jpg', '["雅诗兰黛","精华","小棕瓶"]', '瓶', 5, 0, 799, 80, 550, 79, b'0', NOW(6), NOW(6), b'0'),
-- 运动户外
('prod_yonex_021', 'Yonex 羽毛球拍', '尤尼克斯 羽毛球拍 天斧99 专业级 4U5', '/icon/yonex.jpg', '["尤尼克斯","羽毛球拍","天斧"]', '支', 6, 0, 1299, 30, 900, 129, b'0', NOW(6), NOW(6), b'0'),
('prod_lulu_022', 'Lululemon 瑜伽垫', 'Lululemon 瑜伽垫 5mm 防滑 紫色', '/icon/lulu.jpg', '["Lululemon","瑜伽垫","健身"]', '张', 6, 0, 499, 100, 300, 49, b'1', NOW(6), NOW(6), b'0'),
('prod_decathlon_023', '迪卡侬 帐篷', '迪卡侬 户外帐篷 速开 防雨 3-4人 蓝色', '/icon/decathlon.jpg', '["迪卡侬","帐篷","露营"]', '个', 6, 0, 399, 40, 250, 39, b'0', NOW(6), NOW(6), b'0'),
-- 图书文具
('prod_santi_024', '三体 全集', '刘慈欣 科幻小说 三体全集 套装3册', '/icon/santi.jpg', '["刘慈欣","科幻","三体"]', '套', 7, 0, 89, 200, 50, 8, b'1', NOW(6), NOW(6), b'0'),
('prod_lamy_025', 'LAMY 钢笔', 'LAMY凌美 Safari狩猎者 钢笔 F尖 磨砂黑', '/icon/lamy.jpg', '["LAMY","钢笔","文具"]', '支', 7, 0, 299, 150, 180, 29, b'0', NOW(6), NOW(6), b'0'),
('prod_moleskine_026', 'Moleskine 笔记本', 'Moleskine 经典笔记本 硬面 A5 横线 黑色', '/icon/moleskine.jpg', '["Moleskine","笔记本","手账"]', '本', 7, 0, 189, 120, 100, 18, b'0', NOW(6), NOW(6), b'0'),
-- 母婴用品
('prod_pampers_027', 'Pampers 纸尿裤', '帮宝适 一级帮 纸尿裤 L58片 男女通用', '/icon/pampers.jpg', '["帮宝适","纸尿裤","母婴"]', '包', 8, 0, 99, 300, 70, 9, b'1', NOW(6), NOW(6), b'0'),
('prod_gb_028', '好孩子 婴儿车', '好孩子 婴儿推车 高景观 可坐躺 轻便折叠', '/icon/gb.jpg', '["好孩子","婴儿车","推车"]', '辆', 8, 0, 899, 30, 600, 89, b'0', NOW(6), NOW(6), b'0'),
-- 宠物用品
('prod_royal_029', '皇家 猫粮', '皇家 成猫猫粮 室内家猫 2kg 去毛球配方', '/icon/royal.jpg', '["皇家","猫粮","宠物"]', '袋', 9, 0, 189, 150, 120, 18, b'1', NOW(6), NOW(6), b'0'),
-- 汽车用品
('prod_360_030', '360 行车记录仪', '360 行车记录仪 K980 4K高清 前后双录 停车监控', '/icon/360.jpg', '["360","行车记录仪","汽车"]', '台', 10, 0, 599, 80, 400, 59, b'0', NOW(6), NOW(6), b'0');
